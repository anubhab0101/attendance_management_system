...
int main()
{
	...
	char id_ag[]="25CGUAM";			//faculties id
	char id_jks[]="25CGUPPA";
	char id_mrk[]="25CGUAB";
	char id_sa[]="25CGUPAA";
	char id_tk[]="25CGUPP";			
	
	char pw_ag[]="am";					//faculties pass
	char pw_jks[]="ppa";
	char pw_mrk[]="ab";
	char pw_sa[]="paa";
	char pw_tk[]="pp";
	
	char subjcode1[]="CSE101";			//subject code
	char subjcode2[]="CSE102";
	char subjcode3[]="CSE103";
	char subjcode4[]="CSE104";
	char subjcode5[]="CSE105";
	...
	if(a==0)											//if returning true
	{
		...
		if(p1==0)										//if returning true
		{
			...
			do{	
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/Anubhab/");		//opening directory of speicified path
				if(d)
				{
				...
				char filename[50];
				char c1[]="..//DSUMini/Faculty/Anubhab/";				//path of the faculty database
			...
			char d1[]="..//DSUMini/Faculty/Anubhab/temp";			//path of temporary directory
			char c1[]="..//DSUMini/Faculty/Anubhab/temp/";			//path of temporary directory to access that file
			char c11[]="..//DSUMini/Faculty/Anubhab/";				//path of database
			...
			fprintf(fp,"Subject-Name=DLDA\t\tCOURSECODE=%s\tSubject-Incharge=Anubhab Mohapatra\n",subjc1);
			...
			else if(ch2=='z')
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/Anubhab/");
				if(d)
				{
				...
				char filename[50];
				int f;
				char c1[]="..//DSUMini/Faculty/Anubhab/";
	...
	else
	{
		...
		if(b==0)
		{
			...
			do{	
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/AAM_SIR/");
				if(d)
				{
					printf("\nTotal records In ur Database are as follows\n");
					while((dir=readdir(d))!=NULL)
				...
				char filename[50];
				char c1[]="..//DSUMini/Faculty/AAM_SIR/";
			...
			char d1[]="..//DSUMini/Faculty/AAM_SIR/temp";
			char c1[]="..//DSUMini/Faculty/AAM_SIR/temp/";
			char c11[]="..//DSUMini/Faculty/AAM_SIR/";
			strcat(c1,date);
			strcat(c11,date11);
			//puts(c1);
			char c2[]=".txt";
			...
			fp=fopen(c1,"a+");
			ch=fgetc(fp1);
			fprintf(fp,"Subject-Name=AM3\t\tCOURSECODE=%s\tSubject-Incharge=AAM_SIR\n",subjc1);
			printf("\nPress p for present and a for absent\n");
			while(ch!=EOF)
			{
					if(ch==EOL)
		...
		else
		{
			...
			do{	
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/PPA_SIR/");
				if(d)
				{
					printf("\nTotal records In ur Database are as follows\n");
					while((dir=readdir(d))!=NULL)
				...
				char filename[50];
				char c1[]="..//DSUMini/Faculty/PPA_SIR/";
			...
			char time1[50];
			strftime(time1,50,"%I:%M:%p",time_ptr);
			char d1[]="..//DSUMini/Faculty/PPA_SIR/temp";
			char c1[]="..//DSUMini/Faculty/PPA_SIR/temp/";
			char c11[]="..//DSUMini/Faculty/PPA_SIR/";
			strcat(c1,date);
			strcat(c11,date11);
			//puts(c1);
			char c2[]=".txt";
			...
			fp=fopen(c1,"a+");
			ch=fgetc(fp1);
			fprintf(fp,"Subject-Name=DIS\t\tCOURSECODE=%s\tSubject-Incharge=PPA_SIR\n",subjc1);
			printf("\nPress p for present and a for absent\n");
			while(ch!=EOF)
			{
					if(ch==EOL)
			...
			do{	
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/Prabhu/");
				if(d)
				{
					printf("\nTotal records In ur Database are as follows\n");
					while((dir=readdir(d))!=NULL)
				...
				char filename[50];
				char c1[]="..//DSUMini/Faculty/Prabhu/";
			...
			char time1[50];
			strftime(time1,50,"%I:%M:%p",time_ptr);
			char d1[]="..//DSUMini/Faculty/Prabhu/temp";
			char c1[]="..//DSUMini/Faculty/Prabhu/temp/";
			char c11[]="..//DSUMini/Faculty/Prabhu/";
			strcat(c1,date);
			strcat(c11,date11);
			//puts(c1);
			char c2[]=".txt";
			...
			fp=fopen(c1,"a+");
			ch=fgetc(fp1);
			fprintf(fp,"Subject-Name=DS\t\tCOURSECODE=%s\tSubject-Incharge=Prabhu\n",subjc1);
			printf("\nPress p for present and a for absent\n");
			while(ch!=EOF)
			{
					if(ch==EOL)
			...
			do{	
			{
				...
				DIR *d;
				struct dirent *dir;
				d=opendir("..//DSUMini/Faculty/Aman/");
				if(d)
				{
					printf("\nTotal records In ur Database are as follows\n");
					while((dir=readdir(d))!=NULL)
			...
			char time1[50];
			strftime(time1,50,"%I:%M:%p",time_ptr);
			char d1[]="..//DSUMini/Faculty/Aman/temp";
			char c1[]="..//DSUMini/Faculty/Aman/temp/";
			char c11[]="..//DSUMini/Faculty/Aman/";
			strcat(c1,date);
			strcat(c11,date11);
			//puts(c1);
			char c2[]=".txt";
			...
			fp=fopen(c1,"a+");
			ch=fgetc(fp1);
			fprintf(fp,"Subject-Name=ECCF\t\tCOURSECODE=%s\tSubject-Incharge=Aman\n",subjc1);
			printf("\nPress p for present and a for absent\n");
			while(ch!=EOF)
			{
					if(ch==EOL)
